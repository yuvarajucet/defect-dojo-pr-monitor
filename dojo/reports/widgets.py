...
class ReportOptions(Widget):
    ...
    def get_html(self):
        html = f'<input type="hidden" id="custom_report_name" value="{self.report_name}" disabled style="display:none;" />'
...
# Disabling Table Of Content widget to avoid conflict with PDF genreator. We using default ToC option on PDF generator for more customization
