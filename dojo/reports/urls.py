...
urlpatterns = [
    ...
    re_path(r"^reports/render_report$", views.render_custom_report, name="render_report"),
    re_path(r"^reports/render_cover_page$", views.render_cover_page, name="render_cover_page"),
    re_path(r"^reports/download_report$", views.download_custom_report, name="download_report"),
]
