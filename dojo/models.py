...
class FileUpload(models.Model):
    title = models.CharField(max_length=100, unique=True, default="default_title")
    ...
    storageMode = models.CharField(max_length=50, default="Local")
...
class PRMonitor(models.Model):
    ...
    VALIDATION_STATUS = (
        ...
        (BREAKING_ISSUE, _("Breaking issue"))
    )
    
    pr_title = models.CharField(max_length=300, unique=False, null=True, blank=True)
    pr_number = models.CharField(max_length=10, unique=False, null=False, blank=False, default='0')
    pr_link = models.CharField(max_length=200, unique=False, null=True, blank=True)
    created_by = models.CharField(max_length=100, unique=False, null=True, blank=True)
    target_branch = models.CharField(max_length=50, unique=False, null=True, blank=True)
    product = models.ForeignKey(Product, to_field='name', db_column='product', unique=False, on_delete=models.CASCADE, null=True, blank=True)
    repo_name = models.CharField(max_length=200, null=True, blank=True, unique=False)
    pr_status = models.CharField(max_length=10, choices=PR_STATUS_CHOICE, null=True, blank=True)
    validation_status = models.CharField(max_length=30, choices=VALIDATION_STATUS, null=True, blank=True)
    ticket_link = models.CharField(max_length=200, null=True, blank=True, unique=False)
    issue_reason = models.CharField(max_length=500, null=True, blank=True, unique=False)
    validated_by = models.ForeignKey(Dojo_User, on_delete=models.CASCADE, max_length=100, null=True, blank=True, unique=False)
    validated_at = models.CharField(max_length=200, null=True, blank=True)
    created_at = models.DateTimeField(max_length=200, null=True, blank=True)
    pr_have_critical_file = models.BooleanField(max_length=10, null=True, blank=True)

    class Meta:
        db_table = "pr_monitor"

class PRCommitsLogger(models.Model):

    pr_number = models.CharField(max_length=200, unique=False, null=True, blank=True)
    commit_id = models.CharField(max_length=200, unique=False, null=True, blank=True)
    commit_msg = models.CharField(max_length=100, null=True, blank=True, unique=False)
    product = models.ForeignKey(Product, to_field='name', db_column='product', unique=False, on_delete=models.CASCADE, null=True, blank=True)
    repo_name = models.CharField(max_length=100, unique=False, blank=True, null=True)
    commited_by = models.CharField(max_length=100, unique=False, blank=True, null=True)
    commited_files = models.CharField(max_length=1000, unique=False, blank=True, null=True)
    commited_at = models.DateTimeField(max_length=200, unique=False, blank=True, null=True)

    class Meta:
        db_table = "pr_commit_logger"

class PRMonitorFiles(models.Model):

    unique_id = models.CharField(max_length=100, unique=True, null=True, blank=True)
    product = models.ForeignKey(Product, to_field='name', db_column='product', unique=False, on_delete=models.CASCADE, null=True, blank=True)
    filter_type = models.CharField(max_length=30, unique=False, null=True, blank=True)
    file_names = models.CharField(max_length=1000, unique=False, null=True, blank=True)
    repo_name = models.CharField(max_length=100, null=True, blank=True, unique= False)

    class Meta:
        db_table = "pr_monitor_files"

class PRProjectHandler(models.Model):
    product = models.ForeignKey(Product, to_field='name', db_column='product', unique=False, on_delete=models.CASCADE, null=True, blank=True)
    handled_by = models.ForeignKey(Dojo_User, unique=False, on_delete=models.CASCADE, null=True, blank=True)

    class Meta:
        db_table = "pr_project_handler"
...
class Notification_Webhooks(models.Model):
    class Status(models.TextChoices):
        ...
        ACTIVE_TMP = "active_tmp", _("Active but 5xx (or similar) error detected")
        INACTIVE_TMP = "inactive_tmp", _("Temporary inactive because of 5xx (or similar) error")
        INACTIVE_PERMANENT = "inactive_permanent", _("Permanently inactive")
